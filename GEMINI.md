...
## Project Overview
MD Manager is a Markdown-based static site generated with **Astro 6**. It serves as a personal knowledge base or blog with full-text search, tagging, and dark mode support.
